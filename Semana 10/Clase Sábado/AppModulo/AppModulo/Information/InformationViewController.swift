...
class InformationViewController: UIViewController {
    ...
    private func setTextViewConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            informationTextView.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 24),
            informationTextView.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -24)
        ])
    }
